      ...
      <nav className="navbar container px-1 sm:px-8">
        ...
        <div className="flex items-center space-x-4 xl:space-x-8">
          ...
          <div className="relative">
            <button
              className="bg-white-200 px-4 py-2 rounded-md text-black"
            ...
            {isDropdownOpen && (
              <div className="absolute top-10 right-0 bg-primary shadow-md rounded-md">
                {languages.map((language) => (
                  <button
                    key={language}
                    className="block w-full px-4 py-2 text-left hover:bg-primary text-white"
