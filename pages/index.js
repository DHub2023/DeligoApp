        ...
        <section className="section">
          <div className="flex">
            <div className="w-1/2 p-8">
              <h1 className="mb-4 text-3xl font-bold">Deligo</h1>
              <span className="mb-4 text-2xl font-bold">
                {" "}
                is Best Delivery Service Near You
              </span>
              <p className="mb-4">
                Deligo is a one-stop shop for all your daily necessities. You can
                shop for groceries, and pharmacy items, order food, and send
                important parcels from one place to another from the comfort of
                your home.
              </p>
              <button
                className="d-block  btn btn-primary w-small mt-4"
                type="submit"
              >
                Order Now
              </button>
          ...
          <div className="flex bg-green-200">
            ...
            <div className="w-1/2">
              <br /><br /><br />
              <h2 className="text-2xl font-bold mb-4">Complete Multipurpose eBusiness Solution</h2>
              <p className="text-gray-700 mb-6">
                Deligo is a React and Next JS-based multi-vendor food, grocery, eCommerce, parcel, and pharmacy delivery system. It has six modules to cover all your business function
              </p>
          ...
          <div className="container mx-auto p-8">
            <h1 className="text-4xl font-bold text-center mb-4">Let’s  Start  Earning  with  6amMart</h1>
